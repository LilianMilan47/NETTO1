        ...
        <main>
            ...
            <ul>
                <form method="post" action="creercompte.php">
                    ...
                    <p><input class="cursorPointer" type="submit" value="Créer le compte"></p>
                </form>
                <a class="boutonCompte" href="authentification.php">Déjà un compte ? Se connecter </a>
            </ul>
            <?php
            if (!empty($_POST)) {
                ...
                if (!empty($_POST['login']) && !empty($_POST['pass']) && !empty($_POST['mail']) && !empty($_POST['nom']) && !empty($_POST['prenom'])) {
                    ...
                    echo '<p class="centrerTexte">Création impossible, veuillez ';
                    echo 'réessayer</p>';
                }
            }
            ?>
