    ...
    <body>
        ...
        <main class="centrer">
            ...
            <form method="post" action="vehicules2.php?id=<?= $ligneVehicule['IDVEHICULE'] ?>">
                    ...
                    <ul>
                        ...
                        <div class="centrerElement">
                            ...
                            if ($_SESSION['user']['ADMIN'] == 1 && $ligneVehicule['IDENTRETIEN'] == null) {
                                echo '<li class="bouton"><a href = "operations.php?id=' . $_GET['id'] . '">Créer un entretien</a></li><br>';
                            } else if ($ligneVehicule['IDENTRETIEN'] != null) {
                                echo '<li class="bouton"><a href = "entretiens.php?id=' . $_GET['id'] . '">Voir l\'entretien</a></li><br>';
                            }
                            ?>

                            <?php
                            if ($_SESSION['user']['ADMIN'] == 1 && $ligneVehicule['IDENTRETIEN'] != null) {
                                echo '<li class="boutonSupp"><a href = "vehicules2.php?id=' . $_GET['id'] . '&suppentretien=ok">Supprimer l\'entretien</a></li><br>';
                            }
                            if($_SESSION['user']['ADMIN'] == 1){
                                echo '<li class="boutonSupp"><a href = "vehicules2.php?id=' . $_GET['id'] . '&supp=ok">Supprimer le véhicule</a></li>';
                            }
                            ?>
                        </div>
                ...
                <input class="cursorPointer" type="submit" value="Modifier" />
            </form>
        </main>
