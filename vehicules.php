        ...
        <main class="centrerElement">
            ...
            <ul>
                ...
                foreach ($tabVehicules as $ligne) {
                    echo '<li class="bouton"><a href="vehicules2.php?id=' . $ligne['IDVEHICULE'] . '">' . $ligne['NOMMARQUE'] . ' ' . $ligne['NOMMODELE'] . ' ' . $ligne['IMMAT'] . '</a></li>';
                }
                if ($_SESSION['user']['ADMIN'] == 1) {
                    echo '<li class="bouton"><a href="ajoutvehicule.php">Ajouter un véhicule</a></li>';
                }
                ?>
            </ul>
        </main>
